...
from storefront.models import Product, Commodity, SmartPhoneVariant, SmartPhoneModel, OperatingSystem
from storefront.models import Manufacturer, SmartCard
...
class SmartPhoneAdmin(InvalidateProductCacheMixin, SortableAdminMixin, FrontendEditableAdminMixin,
    ...
    def render_text_index(self, instance):
        template = get_template('search/indexes/storefront/commodity_text.txt')
