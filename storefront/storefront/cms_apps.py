...
class CatalogListApp(CatalogListCMSApp):
    def get_urls(self, page=None, language=None, **kwargs):
        ...
        from storefront.filters import ManufacturerFilterSet
        from storefront.serializers import AddSmartPhoneToCartSerializer, CatalogSearchSerializer
...
class CatalogSearchApp(CatalogSearchCMSApp):
    def get_urls(self, page=None, language=None, **kwargs):
        ...
        from storefront.serializers import ProductSearchSerializer
