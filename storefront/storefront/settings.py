...
ADMINS = [("Dasa Ponnappan", 'dasa@manizh.com')]

# SECURITY WARNING: in production, inject the secret key through the environment
SECRET_KEY = os.environ.get(
    'DJANGO_SECRET_KEY', 'yW5aINuAvLYaHoET5kjc1HJksI4lEgWncx1GpjuECQxhQcPlHb9J6NFxPqRbLGhx')
...
STATICFILES_FINDERS = [
    ...
    'storefront.finders.FileSystemFinder',
    # or 'django.contrib.staticfiles.finders.AppDirectoriesFinder',
    'storefront.finders.AppDirectoriesFinder',
...
CMS_TEMPLATES = [
    ('storefront/pages/default.html', "Default Page"),
]
...
CMSPLUGIN_CASCADE = {
    ...
    'plugins_with_extra_render_templates': {
        'CustomSnippetPlugin': [
            ...
            ('storefront/catalog/manufacturer-filter.html', _("Manufacturer Filter")),
        ],
        # required to purchase real estate
        'ShopAddToCartPlugin': [
            (None, _("Default")),
            ('storefront/catalog/commodity-add2cart.html', _("Add Commodity to Cart")),
        ],
    },
...
SHOP_CART_MODIFIERS = [
    'storefront.modifiers.PrimaryCartModifier',
    'shop.modifiers.taxes.CartExcludedTaxModifier',
    'storefront.modifiers.PostalShippingModifier',
    'storefront.modifiers.StripePaymentModifier',
...
SHOP_STRIPE = {
    ...
    'PURCHASE_DESCRIPTION': _("Thanks for purchasing at storefront"),
}
...
SHOP_CASCADE_FORMS = {
    'CustomerForm': 'storefront.forms.CustomerForm',
}
